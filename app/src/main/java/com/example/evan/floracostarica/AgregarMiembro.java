...
public class AgregarMiembro extends Activity implements OnClickListener {
    ...
    @Override
    public void onClick(View v) {                   //onClick del boton Agregar
        // TODO Auto-generated method stub
        switch (v.getId()) {
            case R.id.btnAgregarId:
                String name = et.getText().toString();
                dbconeccion.insertarDatos(name);
                Intent main = new Intent(AgregarMiembro.this, ListViewActivity.class)
                        .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(main);
                Toast registered= Toast.makeText(AgregarMiembro.this, "Plant added!", Toast.LENGTH_SHORT);
                registered.show();
                break;
